...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link me-2" href="{{ route('adminaccount') }}">Account</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        ...
        @endif
        @foreach (Auth::user()->unreadNotifications as $nt)
            <div class="px-3">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    {{ 'Student with Name: ' . $nt->data['name'] . ' and Email: ' . $nt->data['email'] . ' is successfully Registered' }}
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            </div>
            {{ $nt->markAsRead() }}
                ...
                <table class="table table-striped mt-5">
                    ...
                    @foreach ($student as $st)
                        <tr>
                            ...
                            <td>{{ $st->email }}</td>
                            <td>
                                <a href="{{ route('deletestudent', ['did' => $st->id]) }}"
